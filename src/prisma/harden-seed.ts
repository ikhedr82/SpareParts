import { PrismaClient, SupportStatus, SupportPriority } from '@prisma/client';
...
async function main() {
    ...
    // Find the platform admin for audit logs
    ...
    // 3. Seed Usage Metrics (Historical)
    ...
    // 4. Seed Audit Logs (Activity Stream)
