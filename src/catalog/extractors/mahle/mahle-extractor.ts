...
/**
 * Mahle Aftermarket Parts Extractor
 * 
 * Mahle specializes in engine components and filtration
 */
export class MahleExtractor extends BaseExtractor {
    constructor(outputDirectory: string = 'src/catalog/data/raw/mahle') {
        super({
    ...
    private getCuratedMahleProducts(): RawProduct[] {
        return [
            // Oil Filters
            {
                partNumber: 'OC 205',
