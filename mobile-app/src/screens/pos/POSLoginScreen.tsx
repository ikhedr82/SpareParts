...
export default function POSLoginScreen({ navigation }: any) {
    ...
    return (
        <View style={styles.container}>
            <View style={styles.logoSection}>
                ...
                <Text style={styles.subtitle}>{t('pos.app_title')}</Text>
            </View>
...
const styles = StyleSheet.create({
    ...
    brand: { fontSize: 36, fontWeight: '800', color: BRAND.colors.secondary },
    ...
    input: { backgroundColor: '#fff', padding: 14, borderRadius: BRAND.radius.sm, borderWidth: 1, borderColor: '#E2E8F0', fontSize: 16 },
    rtlInput: { textAlign: 'right' },
    button: { backgroundColor: BRAND.colors.secondary, padding: 16, borderRadius: BRAND.radius.sm, alignItems: 'center', marginTop: 24 },
