...
exports.BremboExtractor = void 0;
const base_extractor_1 = require("../base-extractor");
class BremboExtractor extends base_extractor_1.BaseExtractor {
    constructor(outputDirectory = 'src/catalog/data/raw/brembo') {
        super({
...
exports.BremboExtractor = BremboExtractor;
//# sourceMappingURL=brembo-extractor.js.map