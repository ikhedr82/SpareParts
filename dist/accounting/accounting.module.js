...
exports.AccountingModule = AccountingModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [accounting_service_1.AccountingService, audit_service_1.AuditService],
        exports: [accounting_service_1.AccountingService, audit_service_1.AuditService],
    })
], AccountingModule);
