...
let OrdersController = class OrdersController {
    ...
    findAll(req, businessClientId, status) {
        return this.ordersService.findAll(businessClientId, status);
    }
    findOne(req, id) {
        return this.ordersService.findOne(id);
    }
    updateStatus(req, id, updateOrderStatusDto) {
...
__decorate([
    (0, common_1.Post)(),
    (0, permissions_decorator_1.RequirePermissions)('CREATE_ORDER'),
...
__decorate([
    ...
    __param(0, (0, common_1.Req)()),
    __param(1, (0, common_1.Query)('businessClientId')),
...
__decorate([
    ...
    (0, permissions_decorator_1.RequirePermissions)('UPDATE_ORDER_STATUS'),
    __param(0, (0, common_1.Req)()),
    __param(1, (0, common_1.Param)('id')),
...
__decorate([
    ...
    (0, permissions_decorator_1.RequirePermissions)('CANCEL_ORDER'),
    __param(0, (0, common_1.Req)()),
    __param(1, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String]),
